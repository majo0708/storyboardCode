...
namespace StorybrewScripts
{
    public class Background : StoryboardObjectGenerator
    {
        ...
        [Configurable] public int StartFade = 0;
        [Configurable] public int EndFade = 0;
        ...
        public override void Generate()
        {
            ...
            bg.Fade(StartTime + StartFade, StartTime, 0, Opacity);
            bg.Fade(EndTime, EndTime + EndFade, Opacity, 0);
        }
    }
}
