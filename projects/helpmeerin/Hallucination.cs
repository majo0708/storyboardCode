...
{
    public class Hallucination : StoryboardObjectGenerator
    {
        [Configurable]
        ...
        [Configurable]
        public string Reverse = "reversearrow.png";
        ...
        public void FakePopUp(int startTime, Color4 Color, double beat, OsuHitObject hitobject, int xOffset, int yOffset)
        {
            ...
            var fakeSprite = fakeLayer.CreateSprite(HitcirclePath, OsbOrigin.Centre, hitobject.Position);
            fakeSprite.Scale(OsbEasing.In, hitobject.EndTime, hitobject.EndTime + FadeTime, SpriteScale, SpriteScale * 1.2);
            fakeSprite.Fade(OsbEasing.In, hitobject.StartTime - BeatAR, hitobject.StartTime - BeatAR / 2, 0, 1);
            fakeSprite.Fade(OsbEasing.None, hitobject.EndTime, hitobject.EndTime + FadeTime, 1, 0);
            //localSprite.Additive(hitobject.StartTime - BeatAR, hitobject.EndTime + FadeTime);
            fakeSprite.Color(hitobject.StartTime - BeatAR, Color);
            fakeSprite.Move(startTime, hitobject.Position - offset);
        }
        ...
        public override void Generate()
        {
            ...
            foreach (var hitobject in Beatmap.HitObjects)
            {
                if (!(hitobject is OsuSpinner))
                {
                    ...
                    var aSprite = arLayer.CreateSprite(ApproachcirclePath, OsbOrigin.Centre, hitobject.Position - PosOffset);
                    ...
                    var hSprite = hitobjectLayer.CreateSprite(HitcirclePath, OsbOrigin.Centre, hitobject.Position - PosOffset);
                    ...
                    {
                        var h2Sprite = hitobjectLayer.CreateSprite(HitcircleOverlayPath, OsbOrigin.Centre, hitobject.Position - PosOffset);
                ...
                if (hitobject is OsuSlider)
                {
                    ...
                    while (true)
                    {
                        var sliderEdgeSprite = sliderLayer.CreateSprite(SliderEdge, OsbOrigin.Centre, hitobject.PositionAtTime(startTime) - PosOffset);
                    ...
                    while (true)
                    {
                        var sliderBodySprite = sliderLayer.CreateSprite(SliderBody, OsbOrigin.Centre, hitobject.PositionAtTime(startTime) - PosOffset);
                    ...
                    startTime = hitobject.StartTime;
                    var sliderBallSprite = hitobjectLayer.CreateSprite(SliderBall, OsbOrigin.Centre, hitobject.PositionAtTime(startTime) - PosOffset);
                    ...
                    while (true)
                    {
                        ...
                        sliderBallSprite.Move(startTime, endTime, startPosition, hitobject.PositionAtTime(endTime) - PosOffset);
                    ...
                    if (SliderEndToggle)
                    {
                        var sliderEndaSprite = arLayer.CreateSprite(ApproachcirclePath, OsbOrigin.Centre, hitobject.PositionAtTime(hitobject.EndTime) - PosOffset);
                    ...
                    var sliderEndhSprite = hitobjectLayer.CreateSprite(SliderEnd, OsbOrigin.Centre, hitobject.PositionAtTime(hitobject.EndTime) - PosOffset);
                    ...
                    if (slider.RepeatCount > 0)
                    {
                        ...
                        for (int i = 0; i < slider.RepeatCount; i++)
                        {
                            ...
                            var reverseSprite = hitobjectLayer.CreateSprite(Reverse, OsbOrigin.Centre, hitobject.PositionAtTime(startTime + slider.TravelDuration*(i+1)) - PosOffset);
                    ...
                    if (slider.TravelDurationBeats*SliderTickRate > 1)
                    {
                        ...
                        for (int i = 0; i < tickCount; i++)
                        {
                            ...
                            var sliderTickSprite = sliderLayer.CreateSprite(SliderTick, OsbOrigin.Centre, hitobject.PositionAtTime(startTime + beat*(i+1/SliderTickRate)) - PosOffset);
